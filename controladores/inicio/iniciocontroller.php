			...
			if (in_array($ext_arch2, $ext_permitidas)) {
				if ($err_arch === 0) {
					if ($tam_arch < 10000000) {
						...
						?>
							<a style="color:black;">El archivo es muy pesado, el maximo es 10mb</a>
						<?php
						
					}
				} else {
					?>
					<a style="color:black;">Hubo un error al subir el archivo</a>
					...
					?>
					<a style="color:black;">No se pueden enviar archivos con esa extension"</a>
...
<center>
	...
	<div >
		<form action="<?= FOLDER_PATH . '/inicio/crear_noticia' ?>" method="post" style="width: 350px;" enctype="multipart/form-data">
			...
			<input style="color:red;" type="text" name="titulo" id="titulo" placeholder="Titulo" style="width: 300px;">
			<br>
			<label for="contenido"><font size=4> Contenido</font></label>
			<textarea style="color:red;" name="contenido" id="contenido" placeholder="Contenido" rows="10" style="width: 300px; resize: none;"></textarea>
			<br>
			<center><label for="archivo"><font size=4> Archivo</font></label></center>
			<center><input style="color:red;" type="file" name="archivo" id="archivo" style="width: 300px;"></center>
        ...
        <table class="table">
			...
			<center> 
				...
				<tr>
                    ...
                    <td data-label="descripcion"><p><?= $datos['contenido'] ?></p></td>
