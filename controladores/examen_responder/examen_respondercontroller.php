		...
		if ($query->num_rows) {
			while ($datos = $query->fetch_assoc()) {
				...
				<h2>Pregunta: <?= $datos['quest_desc'] ?></h2>
					<input style="width: 20px; margin: 10px 10px;" type="radio" id="opcion1" name="<?= "opcion".$n ?>" value="1">
					<label for="opcion1" style="margin: 10px 10px;"><?= $datos['ans1'] ?></label>
					<input style="width: 20px; margin: 10px 10px;" type="radio" id="opcion2" name="<?= "opcion".$n ?>" value="2">
					<label for="opcion2" style="margin: 10px 10px;"><?= $datos['ans2'] ?></label>
					<input style="width: 20px; margin: 10px 10px;" type="radio" id="opcion3" name="<?= "opcion".$n ?>" value="3">
					<label for="opcion3" style="margin: 10px 10px;"><?= $datos['ans3'] ?></label>
					<input style="width: 20px; margin: 10px 10px;" type="radio" id="opcion4" name="<?= "opcion".$n ?>" value="4">
					<label for="opcion4" style="margin: 10px 10px;"><?= $datos['ans4'] ?></label>
				<?php
				$n++;
			}
			?>
