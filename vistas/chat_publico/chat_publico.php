...
<body>
	...
	<div id="chat"><!-- Cargamos el encabezado del chat publico -->
	...
	<div id="mensajes"> <!-- Cargamos el estilo de los mensajes--> 
        <div class="mensaje-autor"> <!-- Cargamos el estilo del autor del mensaje --> 
			...
			<link rel="stylesheet" type="text/css" href="/mvc/vistas/includes/css/chat.css"> <!-- Cargamos el estilo del css para el chat publico-->
<?php
	...
	<br>
		<form method="POST" action="<?= FOLDER_PATH . '/chat_publico/enviar_mensaje' ?>"> <!-- Le pasamos los datos al controller mediante el metodo POST para que el envio de datos no sea visible para el usuario--> 
			<input type="hidden" name="usuario_id" value="<?= $id_usuario ?>"> <!-- Le pasamos el id del emisor del mensaje --> 
			<input type="hidden" name="curso_id" value="<?= $id_curso ?>">  <!--Le pasamos el id del receptor del mensaje --> 
